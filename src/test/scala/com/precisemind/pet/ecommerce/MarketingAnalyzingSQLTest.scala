...
import com.precisemind.pet.ecommerce.analyzer.impl.MarketingAnalyzerSQL
...
class MarketingAnalyzingSQLTest extends AnyFunSuite {
  ...
  test("Test top10Campaigns") {
    ...
    val actualRes = MarketingAnalyzerSQL.top10Campaigns(projectedPurchases)
  ...
  test("Test topChannelEachCampaignByUniqSession") {
    ...
    val actualRes = MarketingAnalyzerSQL.topChannelEachCampaignByUniqSession(projectedPurchases)
